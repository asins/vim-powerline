let g:Powerline#Segments#segments = Pl#Segment#Init([
	...
	\ Pl#Segment#Create('fileinfo',
		...
		\ Pl#Segment#Create('filepath'    , '%n|%{Powerline#Functions#GetFilepath()}', Pl#Segment#NoPadding()),
	...
	\ Pl#Segment#Create('lineinfo',
		\ Pl#Segment#Create('line.cur'    , '$LINE %2l'),
		\ Pl#Segment#Create('line.tot'    , ':%-1v|%L', Pl#Segment#NoPadding()),
	\ ),
